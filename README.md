...
## Getting Started
The latest build is available via [JitPack](https://jitpack.io/#com.unary/marquee). Simply add the repository to your `settings.gradle.kts` and the library dependency to your app `build.gradle.kts`.
```
